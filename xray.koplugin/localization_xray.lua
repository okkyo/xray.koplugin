...
function Localization:t(key, ...)
    ...
    if not translation or translation == "" then
        ...
        local fallbacks = {
            ...
            auto_enrich_disabled = "Disabled",
            auto_enrich_setting_title = "Auto-Enrich Cards",
            auto_enrich_preference_desc = "Select your preference for automatic card enrichment:",
            auto_enrich_setting_desc = "When you open a character, location, or term card that is short or out of date, X-Ray can quietly ask the AI to enrich it in the background, then refresh the open card with the new text.\n\nDisabling this stops all automatic enrichment.\n\n[B]Note:[/B] each enrichment uses [B]one[/B] AI API call. This is [B]off by default on slower devices[/B]. Users on free-tier or quota-limited plans may prefer to leave it off.",
            ...
            fetch_more_progress = "Fetching more details...",
            fetch_more_replace_confirm = "Another X-Ray request is still running. Cancel it and fetch details for this entity instead?",
            menu_about = "About",
            ...
            linked_entries_setting_desc = "Linked Entries automatically connects characters, locations, and historical figures when they are named in each other's descriptions or in their found mentions.\n\nDisabling this will hide the 'Linked Entries' button from detail dialogs.",
            ...
            menu_image_search = "Image Search",
            img_attach_button = "Search Images",
            img_change_button = "Change Image",
            img_remove = "Remove Image",
            img_remove_confirm = "Remove the attached image?",
            img_view = "View Image",
            img_more = "More",
            img_search_title = "Search Image",
            img_search_hint = "Enter a name to search",
            img_search_button = "Search",
            img_searching = "Searching for images...",
            img_source_suffix = "  (%s)",
            img_no_results = "No images found.",
            img_no_preview = "(No preview available)",
            img_result_count = "Result %1$d of %2$d",
            img_use_this = "Use This Image",
            img_next = "Next",
            img_prev = "Previous",
